...
export function ProfileEditor({
  ...
  const tabItems = [
    ...
    { id: 'education', label: 'Education', badge: profile.education.length + profile.certifications.length },
...
<Card>
        <CardBody className="space-y-3">
          ...
          {profile.education.map((edu, index) => (
            <div key={edu.id} className="rounded-lg border border-border p-3">
              ...
              <div className="mt-2">
                <Label htmlFor={`edu-${index}-highlights`}>Highlights</Label>
                <Textarea
      ...
      <Card>
        <CardBody className="space-y-4">
          <h2 className="text-sm font-semibold">Certifications ({profile.certifications.length})</h2>
            ...
            <div key={cert.id} className="rounded-lg border border-border p-3">
              ...
              <Button
                ...
                onClick={() =>
                  update(
                    'certifications',
                    profile.certifications.filter((c2) => c2.id !== cert.id),
                  )
                }
              >
        ...
        <CardBody className="space-y-4">
          ...
          {profile.projects.map((proj, index) => (
            <div key={proj.id} className="rounded-lg border border-border p-3">
              ...
              <div className="mt-2">
                <Label htmlFor={`proj-${index}-highlights`}>Highlights</Label>
                <Textarea
