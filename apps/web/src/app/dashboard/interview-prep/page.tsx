...
export default async function InterviewPrepPage() {
  ...
  const preps = [...data.interviewPreps].sort((a, b) =>
    ...
    <>
      ...
      {preps.length === 0 ? (
        ...
        <div className="space-y-6">
          <Alert tone="neutral">
            Answer guidance is a framework to build on with your own real
            experience — never a script to recite. An honest answer about a gap
            is stronger than a rehearsed claim.
          </Alert>
