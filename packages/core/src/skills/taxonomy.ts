...
export const SKILL_CATALOG: SkillEntry[] = [
  ...
  { canonical: "Linux", category: "technical", aliases: ["unix"] },
  {
    ...
    category: "technical",
    aliases: ["monitoring", "datadog", "grafana", "prometheus"],
  },
  ...
  },
  {
    canonical: "Testing",
    category: "technical",
    aliases: ["unit testing", "automated testing", "jest", "vitest", "pytest"],
  },
  {
    canonical: "End-to-End Testing",
    category: "technical",
    aliases: ["e2e testing", "playwright", "cypress"],
    parents: ["Testing"],
  },
  {
    canonical: "Agile",
  ...
  },
  {
    canonical: "Security",
    category: "technical",
    aliases: ["application security", "appsec", "owasp"],
  },
  ...
  { canonical: "Prototyping", category: "technical", parents: ["UX Design"] },
  {
    ...
    category: "domain",
    aliases: ["product strategy", "roadmap"],
  },
  ...
  },
  {
    ...
    category: "soft",
    aliases: ["cross-functional", "teamwork"],
  },
  {
    canonical: "Leadership",
    category: "soft",
    aliases: ["mentoring", "mentorship", "team lead"],
  },
  {
  ...
  },
  {
    canonical: "Ownership",
    category: "soft",
    aliases: ["self-starter", "autonomy"],
  },
  { canonical: "Project Management", category: "soft" },
  {
    canonical: "Customer Focus",
    category: "soft",
    aliases: ["customer obsession", "client facing"],
  },
];
...
for (const entry of SKILL_CATALOG) {
  ...
  for (const a of entry.aliases ?? [])
    aliasIndex.set(a.toLowerCase(), entry.canonical);
}
